                ...
                <form id="addCategoryForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            {{-- Crop Size Category--}}
                            <div class="col-md-2 mb-3 crop_size_div">
                                <div class="input_label">
                                <label for="crop_size" class="form-label">{{ __('Image Size')}}</label>
                                </div>
                            </div>
                            <div class="col-md-10 crop_size mb-3 crop_size_div">
                                            ...
                                            <div class="item_img">
                                                ...
                                                <div class="edit_item_bt">
                                                    @if ($category->category_type == 'product_category')
                                                        <a href="{{ route('items',['list',$category->id]) }}" class="btn edit_item" >{{ __('ADD OR EDIT ITEMS')}}</a>
                                                    @endif
...
@section('page-js')
    ...
    <script type="text/javascript">
                    ...
                    if (response.success == 1)
                    {
                        ...
                        else if(response.category_type == 'parent_category')
                        {
                            ...
                            $('#categories_div input[name="parent_cat"]').change(function() {
                                if ($('#root').is(':checked')) {
                                    $('#editCategoryModal .crop_size_div').show();
        ...
        // Devider Size change
        $('#addCategoryForm #crop_size').on('change', function(){
        ...
        // Devider Size change
        $(document).on('change', '#edit_category_form #crop_size', function() {
            const formID = this.form.id;
            $('#'+formID+' #resize-image').attr('src',"");
            $('#'+formID+' .img-crop-sec').hide();
            $('#'+formID+' #image').val('');
            $('#'+formID+' #category_image').val('');
            $('#'+formID+' #og_image').val('');
        });
