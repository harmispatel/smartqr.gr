...
@section('content')
            ...
            <div class="col-md-8">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('Edit Room')}}</li>
                    </ol>
                </nav>
            </div>
    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <form class="form" action="{{ route('rooms.update') }}" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="card-title">
                            </div>
                            @csrf
                            <input type="hidden" name="shop_id" id="shop_id" value="{{ $shop_id }}">
                            <input type="hidden" name="id" value="{{ $shopRoom->id }}">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="floor" id="floor" class="form-control {{ ($errors->has('floor')) ? 'is-invalid' : '' }}" placeholder="Enter Floor" value="{{ $shopRoom->floor }}" oninput="updateRoomNumber()">
                                            @if($errors->has('floor'))
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="room_no" id="room_no" class="form-control {{ ($errors->has('room_no')) ? 'is-invalid' : '' }}" placeholder="Enter Room" value="{{ $shopRoom->room_no }}">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="status" role="switch" id="status" value="1" {{ ($shopRoom->status == 1) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <hr>
