...
@section('content')
    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <form class="form" action="{{ route('coupons.update') }}" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="option_code" id="option_code" class="form-control">
                                                <option value="0" {{ $coupon->option_code == '0' ? 'selected' : '' }}>{{ __('Manual') }}</option>
                                                <option value="1" {{ $coupon->option_code == '1' ? 'selected' : '' }}>{{ __('Auto Generate') }}</option>
                                            </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" id="code" class="form-control {{ ($errors->has('code')) ? 'is-invalid' : '' }}" placeholder="Enter Coupon Code" value="{{ $coupon->code }}">
                                            @if($errors->has('code'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('code') }}
                                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control {{ ($errors->has('name')) ? 'is-invalid' : '' }}" placeholder="Enter Name" value="{{ $coupon->name }}">
                                            @if($errors->has('name'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('name') }}
                                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="value" id="value" class="form-control {{ ($errors->has('value')) ? 'is-invalid' : '' }}" placeholder="Enter Amount" value="{{ $coupon->value }}">
                                            @if($errors->has('value'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('value') }}
                                                </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="total_users" id="total_users" min="1" class="form-control {{ ($errors->has('total_users')) ? 'is-invalid' : '' }}" placeholder="Enter Repeated Usage" value="{{ $coupon->total_users }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="end_date" id="end_date"  class="form-control  {{$errors->has('end_date') ? 'is-ivalid' : '' }}" value="{{ $coupon->end_date }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="min_cart_amount" id="min_cart_amount" class="form-control {{ ($errors->has('min_cart_amount')) ? 'is-invalid' : '' }}" placeholder="Enter Minimum Amount" value="{{ $coupon->min_cart_amount }}">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="status" role="switch" id="status" value="1" {{ ($coupon->status == 1) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <hr>
