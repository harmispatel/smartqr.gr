            ...
            <div class="col-md-8">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('New Table')}}</li>
                    </ol>
                </nav>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shop_area" id="shop_area" class="form-control {{ ($errors->has('shop_area')) ? 'is-invalid' : '' }}" placeholder="Enter Shop Area" value="{{ old('shop_area') }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="table_name" id="table_name" class="form-control {{ ($errors->has('table_name')) ? 'is-invalid' : '' }}" placeholder="Enter Table" value="{{ old('table_name') }}">
